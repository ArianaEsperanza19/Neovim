...
return {
	...
	config = function()
		...
		wk.add({
			...
			{ "\\g", desc = "Comment/Uncomment", icon = "󰒽" },
			...
			{ "<leader>sl", desc = "Vimtex View", icon = "" },
			{ "<leader>rl", desc = "Vimtex Compile", icon = "󱜧" },
			{ "<leader>sm", desc = "Show markdown", icon = "" },
			{ "<leader>st", desc = "Show typst", icon = "" },
			...
			{ "viw]", desc = "Surround", icon = "󰅩" },
			{ "viw]v", desc = "Surround visual", icon = "󰅩" },
			{ "viwgu", desc = "Lowercase", icon = "" },
			{ "viwgU", desc = "Uppercase", icon = "" },
